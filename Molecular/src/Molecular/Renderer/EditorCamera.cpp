...
namespace Molecular
{
	...
	void EditorCamera::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(MOL_BIND_EVENT_FN(EditorCamera::OnMouseScroll));
    	dispatcher.Dispatch<WindowResizeEvent>(MOL_BIND_EVENT_FN(EditorCamera::OnWindowResized));
